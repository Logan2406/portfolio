        ...
        <div className="d-flex project-skill-det flex-column align-items-center" style={{padding:"20px"}}>
          ...
          <div style={{border:"2px solid",padding:"10px"}}>
            ...
            <div style={{display:'flex',width:"100%",justifyContent:'center'}}>
                <AiFillGithub style={{fontSize:'30px'}}/><a href={item.github_link}  target="_blank" style={{fontSize:'20px',marginLeft:'10px',textDecoration:'none',color:"#00f100"}}>Github Repo</a>
            </div>
      </div>
      </>
    )
